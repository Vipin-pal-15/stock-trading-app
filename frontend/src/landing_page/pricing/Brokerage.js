      ...
      <div className="row p-5 mt-5 text-center border-top">
        <div className="col-8 p-4">
          ...
          <ul style={{textAlign:"left",lineHeight:"2.5", fontSize:"12px"}} className="text-muted">
            ...
            <li>
              For NRI account (PIS), o.o5% or ₹200 per executed order for equity (whichever is lower).
            </li>
            <li>
              If the account is in debit balance, any order placed will charged ₹40 per order instead of ₹20 per executed order.
            </li>
          </ul>
        </div>
